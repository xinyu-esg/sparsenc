...
The support of original RLNC is straightforward as it is just a special case of SNC with the number of subgenerations being 1. The CBD decoder is recommended for decoding RLNC.
